...
if [ -z "$@" ]; then
  runTestTarget OpenSMOKEpp_CHEMKIN_PreProcessor
  runTestTarget OpenSMOKEpp_ThermodynamicEquilibrium
  ...
  runTestTarget OpenSMOKEpp_PartiallyStirredReactor
  runTestTarget OpenSMOKEpp_CounterFlowFlame1D
  runTestTarget OpenSMOKEpp_PremixedLaminarFlame1D
  runTestTarget OpenSMOKEpp_SurfaceBatchReactor
